/* eslint-disable */
// Generated by Wrangler by running `wrangler types --include-runtime` (hash: 8907c4a81aa7a098539b519290acf0c4)
// Runtime types generated with workerd@1.20250617.0 2024-01-01
declare namespace Cloudflare {
	interface Env {
		SQL: DurableObjectNamespace<import('./src/index').SQLiteDurableObject>;
	}
}
...
declare namespace TailStream {
	...
	type TailEventHandlerName =
		...
		| 'link'
		| 'attributes';
	type TailEventHandlerObject = Record<
		TailEventHandlerName,
		TailEventHandler
	>;
