...
import { GET_DOCUMENT, SEARCH_DOCUMENTS, STORE_DOCUMENT, DELETE_DOCUMENT } from './operations/documents';
...
export {
  GET_VECTOR, SEARCH_VECTORS, PUT_VECTOR, DELETE_VECTOR,
  GET_DOCUMENT, SEARCH_DOCUMENTS, STORE_DOCUMENT, DELETE_DOCUMENT,
  EMBED, DELETE_ALL_VECTORS
};
